...
//----< return the children of a elment if it has this member, return ????????>-----------------------------

std::vector<std::shared_ptr<AbstractXmlElement>> AbstractXmlElement::getChildren(){ 
	std::vector<std::shared_ptr<AbstractXmlElement>> v;
	return v;
}  //added by Wenting Wang
std::vector<std::pair<std::string, std::string>> AbstractXmlElement::getAttributes(){
...
//----< generate xml string for DeclarElement >-------------------------------
...
//----< add attribute to DeclarElement >-----------------------------------
...
//----< remove attribute from DeclarElement >------------------------------
