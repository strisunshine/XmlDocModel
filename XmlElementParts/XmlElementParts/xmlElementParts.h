...
//                 Wenting Wang (made some small changes)          //
//                 wwang34@syr.edu                                 //
/////////////////////////////////////////////////////////////////////
/*
  Module Operations: 
  ...
  ====================
  ver 1.4 : 19 Mar 09 
  - inside XmlParts::get(), pass toks vector to the called getTok(), as
    pToker->getTok(toks). Originally the isBeginQuote() inside getTok()
	will return true for all the quote pairs it finds, including those
	within text element. The toks vector is passed to decide if the 
	quote is attribute value or text. - Wang
  ver 1.3 : 31 Jan 09
